...
router.post("/register", (req, res, next) => {
    ...
    Hotel.addHotel(newHotel, (err, hotel) => {
        if (err) {
            ...
            hotel.numberOfRooms.one_b = hotel.numberOfRoomsAvailable.one_b = parseInt(
                req.body.one_b
            );
            hotel.numberOfRooms.two_b = hotel.numberOfRoomsAvailable.two_b = parseInt(
                req.body.two_b
            );
            hotel.numberOfRooms.three_b = hotel.numberOfRoomsAvailable.three_b = parseInt(
                req.body.three_b
            );
            hotel.numberOfRooms.vila = hotel.numberOfRoomsAvailable.vila = parseInt(
                req.body.vila
            );
...
// Get Hotel Profile for the Hotel managers
router.get(
    "/profile",
